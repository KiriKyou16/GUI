...
public class TTT {
	...
	private void initialize() {
		...
		BTReset.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		panel_14.add(BTReset, BorderLayout.CENTER);
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int result = JOptionPane.showConfirmDialog(frame, "Confirm if you want to exit", "Tic Tac Toe", JOptionPane.YES_NO_OPTION);
